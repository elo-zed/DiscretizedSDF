...
def evaluation_shinyblender(gt_mesh, out_mesh, vis_out_dir, downsample_density=0.3, patch_size=60, max_dist_d=100, 
                    max_dist_t=10, visualize_threshold=10, points_for_plane=None, nonvalid_bbox=None):
    mp.freeze_support()
